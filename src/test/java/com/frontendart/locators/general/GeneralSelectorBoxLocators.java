...
//			+ "text()='Save and close']", Arrays.asList("Mentés és bezárás", "Save and close")),
	SELECTOR_BOX_CONNECT_AND_CLOSE_BUTTON(SELECTOR_BOX + "//a//span[text()='Csatol & bezár' or "
			+ "text()='Connect & close']", Arrays.asList("Csatol & bezár", "Connect & close")),
	
	SELECTOR_BOX_SAVE_AND_CLOSE_BUTTON(SELECTOR_BOX + "//a//span[text()='Mentés és bezárás' or text()='Save and close' or text()='Csatol & bezár' or text()='Connect & close']", Arrays.asList("Mentés és bezárás", "Save and close")),
	...
	FIND_SUBTYPE_SAVE_AND_CLOSE_BUTTON(FIND_SUBTYPE_WINDOW + "//a//span[text()='Mentés és bezárás' or text()='Save and close' or text()='Csatol & bezár' or text()='Connect & close']", Arrays.asList("Mentés és bezárás", "Save and close")),
	...
	FIND_INSTITUTES_FILTER_BUTTON(FIND_INSTITUTES_WINDOW + "//span[text()='Szűkítés' or text()='Filter']", Arrays.asList("Szűrés", "Filter")),
	FIND_INSTITUTES_SAVE_AND_CLOSE_BUTTON(FIND_INSTITUTES_WINDOW + "//a//span[text()='Mentés és bezárás' or "
			+ "text()='Save and close']", Arrays.asList("Mentés és bezárás", "Save and close"));
