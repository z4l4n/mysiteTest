...
public enum QueryEditorLocators implements GeneralLocatorTypes {
    ...
    EVERY_CONDITION_OPTION(
            "//span[starts-with(@id, 'menucheckitem')][text()='Every condition' or text()='Minden szabály']",
            Arrays.asList("Mindegyik feltétel", "Every condition")),
    ANY_CONDITION_OPTION(
            "//span[starts-with(@id, 'menucheckitem')][text()='Any condition' or text()='Valamelyik szabály']",
            Arrays.asList("Bármelyik feltétel", "Any condition")),
    ...
    MATCH_SELECTOR_PREFIX_MATCH_OPTION(
            "//span[starts-with(@id, 'menucheckitem')][text()='prefix match' or text()='Szöveg eleji egyezés']",
            Arrays.asList("prefix match", "Szöveg eleji egyezés")),
    MATCH_SELECTOR_POSTFIX_MATCH_OPTION(
            "//span[starts-with(@id, 'menucheckitem')][text()='postfix match' or text()='Szöveg végi egyezés']",
            Arrays.asList("postfix match", "Szöveg végi egyezés")),
    MATCH_SELECTOR_ANY_MATCH_OPTION(
            "//span[starts-with(@id, 'menucheckitem')][text()='any match' or text()='Bármilyen egyezés']",
            Arrays.asList("any match", "Bármilyen egyezés")),
    MATCH_SELECTOR_ANY_MATCH_IN_WORDS_OPTION(
            "//span[starts-with(@id, 'menucheckitem')][text()='any match in words' or text()='Bármilyen egyezés szavanként']",
            Arrays.asList("any match in words", "Bármilyen egyezés szavanként")),
    MATCH_SELECTOR_EXACT_MATCH_OPTION(
            "//span[starts-with(@id, 'menucheckitem')][text()='exact match' or text()='Teljes egyezés' or text()='=']",
            Arrays.asList("exact match", "Teljes egyezés")),
    MATCH_SELECTOR_NOT_EXACT_MATCH_OPTION(
            "//span[starts-with(@id, 'menucheckitem')][text()='not exact match' or text()='Nem teljes egyezés'  or text()='!=']",
            Arrays.asList("not exact match", "Nem teljes egyezés")),
    MATCH_SELECTOR_IS_NULL_OPTION(
            "//span[starts-with(@id, 'menucheckitem')][text()='is null' or text()='Üres']",
            Arrays.asList("is null", "Üres")),
    MATCH_SELECTOR_NOT_NULL_OPTION(
            "//span[starts-with(@id, 'menucheckitem')][text()='not null' or text()='Nem üres']",
            Arrays.asList("not null", "Nem üres")),
    MATCH_SELECTOR_ME_OPTION(
            "//span[starts-with(@id, 'menucheckitem')][text()='is me' or text()='én vagyok']",
            Arrays.asList("is me", "én vagyok")),
    MATCH_SELECTOR_ME_OR_DELEGATED_OPTION(
            "//span[starts-with(@id, 'menucheckitem')][text()='is me or delegated' or text()='én vagyok, vagy egy delegált szerző']",
            Arrays.asList("is me or delegated", "én vagyok, vagy egy delegált szerző")),
    ...
    NEW_CONDITION_INPUT(
            SEARCH_PANEL + "//div[starts-with(@id, 'conditionselectorwithmenu')]//input[@placeholder='Új feltétel' or "
                    + "@placeholder='New Condition']",
            Arrays.asList("Új szabály", "New condition")),
    ...
    CONDITIONS_CONTAINER(
            SEARCH_PANEL + "//*/div[contains(@id, 'conditionscontainer')][contains(@class, 'x-panel searchconditions-container')]"),
    ...
    LAST_COUPLED_CONDITION_NEW(
            SEARCH_PANEL + "//div[starts-with(@id, 'coupledsearchcondition')]//a[contains(@id, 'searchconditionselector')][last()]"),
