 ...
 *
 */
public enum ForumTableAttributes implements GeneralTableAttributes {
	 ...
	 */
	private ForumTableAttributes(final List<String> names, final FieldTypeLocators fieldType) {
		this.names = names;
	 ...
	 * @param isDisabledByDefault
	 */
	private ForumTableAttributes(final List<String> names, final FieldTypeLocators fieldType, final List<RecordAttributeFlags> attributeFlags) {
		this.names = names;
		this.fieldType = fieldType;
