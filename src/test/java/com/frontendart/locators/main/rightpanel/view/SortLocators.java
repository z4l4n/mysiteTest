...
public enum SortLocators implements GeneralLocatorTypes {
	...
	NEW_SORTING_BUTTON(SORTING_WIDGET + "//*/a[starts-with(@data-qtip, 'Új rendezés hozzáadása') or "
			+ "starts-with(@data-qtip, 'Add new sorting')]", Arrays.asList("Új rendezés", "New sorting")),
	...
	DELETE_ALL_SORTING_BUTTON(SORTING_WIDGET + "//*/a[starts-with(@data-qtip, 'Minden rendezés törlése') or "
