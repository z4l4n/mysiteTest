...
public enum AdminRecordAttributes implements GeneralTableAttributes {
	...
	ADMIN_ROLES(Arrays.asList("Admin jogkörök", "admin roles"), FieldTypeLocators.RECORDSELECTORLISTFIELD, Arrays.asList(RecordAttributeFlags.REQUIRED, RecordAttributeFlags.EXTENDABLE)),
	 ...
	 * @param isDisabledByDefault
	 */
	private AdminRecordAttributes(final List<String> names, final FieldTypeLocators fieldType, final List<RecordAttributeFlags> attributeFlags) {
		this.names = names;
		this.fieldType = fieldType;
