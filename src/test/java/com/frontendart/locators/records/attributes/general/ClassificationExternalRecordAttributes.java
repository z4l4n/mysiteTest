 ...
 *
 */
public enum ClassificationExternalRecordAttributes implements GeneralTableAttributes {
	TREE(Arrays.asList("Hierarchia", "Tree"), FieldTypeLocators.RECORDSELECTORFIELD, Arrays.asList(RecordAttributeFlags.REQUIRED, RecordAttributeFlags.EXTENDABLE)),
	 ...
	 */
	private ClassificationExternalRecordAttributes(final List<String> names, final FieldTypeLocators fieldType) {
		this.names = names;
	 ...
	 * @param isDisabledByDefault
	 */
	private ClassificationExternalRecordAttributes(final List<String> names, final FieldTypeLocators fieldType, final List<RecordAttributeFlags> attributeFlags) {
		this.names = names;
		this.fieldType = fieldType;
