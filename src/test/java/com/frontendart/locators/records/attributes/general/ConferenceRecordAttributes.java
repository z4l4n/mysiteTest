...
public enum ConferenceRecordAttributes implements GeneralTableAttributes {
	...
	LOCATION(Arrays.asList("Helyszín", "Location"), FieldTypeLocators.RECORDSELECTORLISTFIELD, Arrays.asList(RecordAttributeFlags.REQUIRED)),
	 ...
	 * @param isDisabledByDefault
	 */
	private ConferenceRecordAttributes(final List<String> names, final FieldTypeLocators fieldType, final List<RecordAttributeFlags> attributeFlags) {
		this.names = names;
		this.fieldType = fieldType;
