...
/**
 * Enum class for locating the elements on the Country page.
 * @author Zoli
 *
 */
public enum CountryRecordAttributes implements GeneralTableAttributes {
	 ...
	 */
	private CountryRecordAttributes(final List<String> names, final FieldTypeLocators fieldType) {
		this.names = names;
	 ...
	 * @param isDisabledByDefault
	 */
	private CountryRecordAttributes(final List<String> names, final FieldTypeLocators fieldType, final List<RecordAttributeFlags> attributeFlags) {
		this.names = names;
		this.fieldType = fieldType;
