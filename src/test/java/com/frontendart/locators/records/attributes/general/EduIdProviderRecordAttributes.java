 ...
 *
 */
public enum EduIdProviderRecordAttributes implements GeneralTableAttributes {
	 ...
	 */
	private EduIdProviderRecordAttributes(final List<String> names, final FieldTypeLocators fieldType) {
		this.names = names;
	 ...
	 * @param isDisabledByDefault
	 */
	private EduIdProviderRecordAttributes(final List<String> names, final FieldTypeLocators fieldType, final List<RecordAttributeFlags> attributeFlags) {
		this.names = names;
		this.fieldType = fieldType;
