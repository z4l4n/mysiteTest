 ...
 *
 */
public enum ExportFormatRecordAttributes implements GeneralTableAttributes {
	 ...
	 */
	private ExportFormatRecordAttributes(final List<String> names, final FieldTypeLocators fieldType) {
		this.names = names;
	 ...
	 * @param isDisabledByDefault
	 */
	private ExportFormatRecordAttributes(final List<String> names, final FieldTypeLocators fieldType, final List<RecordAttributeFlags> attributeFlags) {
		this.names = names;
		this.fieldType = fieldType;
