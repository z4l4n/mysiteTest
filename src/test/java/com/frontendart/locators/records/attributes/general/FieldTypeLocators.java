...
public enum FieldTypeLocators {
	...
	EMAILFIELD(Constants.FIELD_INPUT_XPATH, "featest.dummy@gmail.com"),
	...
	STATUS_TYPE_COMBOBOX(Constants.FIELD_INPUT_XPATH, ChangeStatusTypes.values()[Utils.randInt(1, ChangeStatusTypes.values().length) - 1].getHunName()),
	IMPORT_ALIAS_TYPE_COMBOBOX(Constants.FIELD_INPUT_XPATH, ImportAliasTypes.values()[Utils.randInt(1, ImportAliasTypes.values().length) - 1].getHunName()),
	...
	private FieldTypeLocators() {
		this.editableFieldXpath = Constants.FIELD_INPUT_XPATH;
		randomValue = "";
	}
	...
	private FieldTypeLocators(final String locator) {
		this.editableFieldXpath = locator;
		randomValue = "";
	}
	...
	public String getEditableFieldXpath() {
		return this.editableFieldXpath;
	}
