...
public enum ForumRecordAttributes implements GeneralTableAttributes {
	...
	AVAILABILITY(Arrays.asList("hatókör", "scope"), FieldTypeLocators.ENUMSELECTORCOMBOBOX, Arrays.asList(RecordAttributeFlags.REQUIRED)),
	 ...
	 * @param isDisabledByDefault
	 */
	private ForumRecordAttributes(final List<String> names, final FieldTypeLocators fieldType, final List<RecordAttributeFlags> attributeFlags) {
		this.names = names;
		this.fieldType = fieldType;
