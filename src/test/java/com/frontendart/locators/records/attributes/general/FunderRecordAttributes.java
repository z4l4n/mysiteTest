...
public enum FunderRecordAttributes implements GeneralTableAttributes {
	...
	ABBREVIATION_ENG(Arrays.asList("Rövidítés angolul", "api.model.Organization.abbreviationEng.label"), FieldTypeLocators.TEXTFIELD, Arrays.asList(RecordAttributeFlags.REQUIRED));
	 ...
	 */
	private FunderRecordAttributes(final List<String> names, final FieldTypeLocators fieldType, final List<RecordAttributeFlags> attributeFlags) {
		this.names = names;
