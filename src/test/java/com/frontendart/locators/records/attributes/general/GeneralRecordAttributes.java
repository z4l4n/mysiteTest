...
public enum GeneralRecordAttributes implements GeneralTableAttributes {
	...
	LAST_MODIFICATION(Arrays.asList("Utolsó módosítás", "Last modification"), FieldTypeLocators.NO_INPUT, Arrays.asList(RecordAttributeFlags.DISABLED));
	 ...
	 * @param isDisabledByDefault
	 */
	private GeneralRecordAttributes(final List<String> names, final FieldTypeLocators fieldType, final List<RecordAttributeFlags> attributeFlags) {
		this.names = names;
		this.fieldType = fieldType;
