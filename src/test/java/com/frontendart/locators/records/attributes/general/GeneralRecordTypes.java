...
public enum GeneralRecordTypes {
	...
	AUTHOR(Arrays.asList("Szerző", "Author"), AuthorRecordAttributes.class, Arrays.asList(RecordTypeFlags.HAS_REQUIRED_FIELDS, RecordTypeFlags.HAS_EXTENDABLE_FIELDS)),
	...
	INSTITUTE(Arrays.asList("Intézmény", "Institute"), InstituteRecordAttributes.class, Arrays.asList(RecordTypeFlags.HAS_REQUIRED_FIELDS, RecordTypeFlags.HAS_EXTENDABLE_FIELDS)),
	INSTITUTE_TYPE(Arrays.asList("Intézménytípus", "Institute Type"), InstituteTypeRecordAttributes.class, Arrays.asList(RecordTypeFlags.NONE)),
	...
	//New types
	EMAIL_NOTIFICATIONS_TIMES(Arrays.asList("E-mail értesítési idők", "E-mail notification times"), EmailNotificationTimesRecordAttributes.class),
	...
	CLASSIFICATION_EXTERNAL(Arrays.asList("Tudományterület (külső)", "Classification (external)"), ClassificationExternalRecordAttributes.class),
	...
	private GeneralRecordTypes(final List<String> names, final Class<? extends GeneralTableAttributes> attributes) {
		...
		this.recordFlags = Arrays.asList(RecordTypeFlags.HAS_REQUIRED_FIELDS);
	}
	 ...
	 * @param pageToValidate
	 */
	private GeneralRecordTypes(final List<String> names, final Class<? extends GeneralTableAttributes> attributes, final List<RecordTypeFlags> flags) {
		this.names = names;
		this.attributes = attributes;
	...
	public static List<GeneralTableAttributes> getNotDisabledAttributes(final Class<? extends GeneralTableAttributes> attributes) {
		final List<GeneralTableAttributes> notDisabledAttributes = new ArrayList<GeneralTableAttributes>();
	...
	public static List<GeneralTableAttributes> getNotExtendableAttributes(final Class<? extends GeneralTableAttributes> attributes) {
		final List<GeneralTableAttributes> notExtendableAttributes = new ArrayList<GeneralTableAttributes>();
		for (final GeneralTableAttributes attribute : attributes.getEnumConstants()) {
	...
	public static List<GeneralTableAttributes> getSearchableAttributes(final Class<? extends GeneralTableAttributes> attributes) {
		final List<GeneralTableAttributes> searchableAttributes = new ArrayList<GeneralTableAttributes>();
		for (final GeneralTableAttributes attribute : attributes.getEnumConstants()) {
