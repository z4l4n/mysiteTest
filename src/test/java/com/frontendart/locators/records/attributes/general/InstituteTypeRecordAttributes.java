...
public enum InstituteTypeRecordAttributes implements GeneralTableAttributes {
	...
	NAME_ENG(Arrays.asList("Név angolul", "Name Eng"), FieldTypeLocators.TEXTFIELD),
	 ...
	 * @param isDisabledByDefault
	 */
	private InstituteTypeRecordAttributes(final List<String> names, final FieldTypeLocators fieldType, final List<RecordAttributeFlags> attributeFlags) {
		this.names = names;
		this.fieldType = fieldType;
