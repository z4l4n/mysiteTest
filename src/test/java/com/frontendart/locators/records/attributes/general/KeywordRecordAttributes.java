...
/**
 * Enum class for locating the elements on the Keyword page.
 * @author Zoli
 *
 */
public enum KeywordRecordAttributes implements GeneralTableAttributes {
	...
	KEYWORD(Arrays.asList("Kulcsszó", "Keyword"), FieldTypeLocators.TEXTAREAFIELD, Arrays.asList(RecordAttributeFlags.REQUIRED)),
	 ...
	 */
	private KeywordRecordAttributes(final List<String> names, final FieldTypeLocators fieldType) {
		this.names = names;
	 ...
	 * @param isDisabledByDefault
	 */
	private KeywordRecordAttributes(final List<String> names, final FieldTypeLocators fieldType, final List<RecordAttributeFlags> attributeFlags) {
		this.names = names;
		this.fieldType = fieldType;
