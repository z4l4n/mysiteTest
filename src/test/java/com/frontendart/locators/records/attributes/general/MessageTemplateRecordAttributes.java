 ...
 *
 */
public enum MessageTemplateRecordAttributes implements GeneralTableAttributes {
	 ...
	 */
	private MessageTemplateRecordAttributes(final List<String> names, final FieldTypeLocators fieldType) {
		this.names = names;
	 ...
	 * @param isDisabledByDefault
	 */
	private MessageTemplateRecordAttributes(final List<String> names, final FieldTypeLocators fieldType, final List<RecordAttributeFlags> attributeFlags) {
		this.names = names;
		this.fieldType = fieldType;
