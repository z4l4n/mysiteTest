...
/**
 * Enum class for locating the attributes on the Project page.
 * @author Zoli
 *
 */
public enum ProjectRecordAttributes implements GeneralTableAttributes {
	...
	NUMBER(Arrays.asList("Pályázati szám", "Grant number"), FieldTypeLocators.TEXTFIELD, Arrays.asList(RecordAttributeFlags.REQUIRED)),
	NAME(Arrays.asList("Projektnév", "Name"), FieldTypeLocators.TEXTAREAFIELD),
	 ...
	 */
	private ProjectRecordAttributes(final List<String> names, final FieldTypeLocators fieldType) {
		this.names = names;
	 ...
	 * @param isDisabledByDefault
	 */
	private ProjectRecordAttributes(final List<String> names, final FieldTypeLocators fieldType, final List<RecordAttributeFlags> attributeFlags) {
		this.names = names;
		this.fieldType = fieldType;
