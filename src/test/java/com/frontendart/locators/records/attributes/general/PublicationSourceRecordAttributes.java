...
public enum PublicationSourceRecordAttributes implements GeneralTableAttributes {
	SUBTYPE(Arrays.asList("Altípus", "Subtype"), FieldTypeLocators.ENUMSELECTORCOMBOBOX, Arrays.asList(RecordAttributeFlags.REQUIRED)),
	 ...
	 * @param isDisabledByDefault
	 */
	private PublicationSourceRecordAttributes(final List<String> names, final FieldTypeLocators fieldType, final List<RecordAttributeFlags> attributeFlags) {
		this.names = names;
		this.fieldType = fieldType;
