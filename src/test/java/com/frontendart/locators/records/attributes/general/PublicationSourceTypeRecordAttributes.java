 ...
 *
 */
public enum PublicationSourceTypeRecordAttributes implements GeneralTableAttributes {
	...
	NAME_ENG(Arrays.asList("Név angolul", "nameEnf"), FieldTypeLocators.TEXTFIELD, Arrays.asList(RecordAttributeFlags.REQUIRED));
	 ...
	 */
	private PublicationSourceTypeRecordAttributes(final List<String> names, final FieldTypeLocators fieldType) {
		this.names = names;
	 ...
	 * @param isDisabledByDefault
	 */
	private PublicationSourceTypeRecordAttributes(final List<String> names, final FieldTypeLocators fieldType, final List<RecordAttributeFlags> attributeFlags) {
		this.names = names;
		this.fieldType = fieldType;
