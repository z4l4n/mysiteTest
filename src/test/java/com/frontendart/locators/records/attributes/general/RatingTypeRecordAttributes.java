...
public enum RatingTypeRecordAttributes implements GeneralTableAttributes {
	...
	CLASS(Arrays.asList("Osztály", "Class"), FieldTypeLocators.TEXTFIELD, Arrays.asList(RecordAttributeFlags.REQUIRED)),
	 ...
	 * @param isDisabledByDefault
	 */
	private RatingTypeRecordAttributes(final List<String> names, final FieldTypeLocators fieldType, final List<RecordAttributeFlags> attributeFlags) {
		this.names = names;
		this.fieldType = fieldType;
