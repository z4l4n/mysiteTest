...
public enum WorkflowRecordAttributes implements GeneralTableAttributes {
	...
	RECORD_TYPE(Arrays.asList("Kezelt típus", "recordType"), FieldTypeLocators.ENUMSELECTORCOMBOBOX, Arrays.asList(RecordAttributeFlags.REQUIRED));
	 ...
	 * @param isDisabledByDefault
	 */
	private WorkflowRecordAttributes(final List<String> names, final FieldTypeLocators fieldType, final List<RecordAttributeFlags> attributeFlags) {
		this.names = names;
		this.fieldType = fieldType;
