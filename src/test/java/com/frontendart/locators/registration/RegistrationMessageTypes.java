...
public enum RegistrationMessageTypes implements GeneralLocatorTypes {
	SUCCESSFUL(Arrays.asList("A regisztrációs kérelmet befogadtuk. Nemsokára kap egy levelet, amiben talál egy linket, amin meg kell erősítenie regisztrációját.",
	...
	UNSUCCESSFUL_DATA_POLICY(Arrays.asList("Kérjük fogadja el az adatkezelési nyilatkozatot!",
			"Please accept the data handling policy!")),
	UNSUCCESSFUL_INCORRECT_FIELD(Arrays.asList("Néhány szükséges mezőt nem helyesen töltött ki!",
