...
public class Gui2SearchTest extends Gui2JunitTestClass {
    ...
    /**
     * Simple search for string Redmine issue number: <a href="https://redmine.mt2.dsd.sztaki.hu:18018/issues/1371">#1371</a> Redmine issue
     * number: <a href="https://redmine.mt2.dsd.sztaki.hu:18018/issues/1720">#1720</a>
     *
    ...
    public final void testSimpleSearch() {
        ...
        for (final WebElement result : searchResults) {
            ...
            assertTrue("This text does not contain the search text: " + textOfThisResult,
                    textOfThisResult.toLowerCase(Locale.ENGLISH).contains("d".toLowerCase(Locale.ENGLISH)));
        }
    ...
    public final void testAdvancedSearchFieldLabels() {
        ...
        final List<String> labelsAsString = new ArrayList<>();
