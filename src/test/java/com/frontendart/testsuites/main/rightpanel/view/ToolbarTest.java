...
public class ToolbarTest extends JunitTestClass {
    ...
    /**
     * Basic search toolbar test Redmine issue number:
     * <a href="https://redmine.mt2.dsd.sztaki.hu:18018/issues/1047">#1047</a>
     * Redmine issue number:
     * <a href="https://redmine.mt2.dsd.sztaki.hu:18018/issues/1276">#1276</a>
     */
    ...
    /**
     * Search toolbar page check after clicking on Select All button Redmine issue
     * number:
    ...
    /**
     * Search toolbar page check after more than one items are selected. Redmine
     * issue number:
    ...
    /**
     * Search toolbar page - citations button is present only if publication record
     * type is selected.
     */
    @Test
    @Category(CoreSuite.class) // seems ok
    ...
    /**
     * simple citation creation Redmine issue number:
     * <a href="https://redmine.mt2.dsd.sztaki.hu:18018/issues/1629">#1629</a>
     * 
     * TODO: reimplement
     */
