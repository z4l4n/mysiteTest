...
public class ViewVersionsTest extends SelectRandomRecordTypeJunitTestClass {
    ...
    // This test class should only run with admin (mtmtuser4) rights - meaning that
     ...
     */
    /*
     * @Test public final void testRestoreVersion() { // Select random record type,
     * and select random record WebElement myRecordRow =
     * RecordSelectionManager.selectRandomRenderedRowsFromGridPanel(1).get(0); final
