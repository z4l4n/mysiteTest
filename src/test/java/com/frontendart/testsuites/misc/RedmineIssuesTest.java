...
public class RedmineIssuesTest extends JunitTestClass {
	...
	/**
	 * Create ticket for Admin record type
	 * Redmine issue number: <a href="https://redmine.mt2.dsd.sztaki.hu:18018/issues/2915">#2915</a>
	 */
	@Test
	 ...
	 * 
	 * Duplicate - check admin comment field is empty
	 * Redmine issue number: <a href="https://redmine.mt2.dsd.sztaki.hu:18018/issues/2899">#2899</a>
	 */

	/**
	 * Check publications attribute order
	 * Redmine issue number: <a href="https://redmine.mt2.dsd.sztaki.hu:18018/issues/2957">#2957</a>
	 */
	@Test
	...
	public final void testPublicationsAttributeOrder() {
		...
		final List<WebElement> allLabels = Utils.createGeneralWebElementsFromEnum(RecordEditorLocators.EDITOR_FORM_FIELDS_VISIBLE_LABELS_ALTERNATIVE);
...
//		RecordSelectionManager.waitUntilTableIsReady();
	...
	/**
	 * Admin forum button after logout/login
	 * Redmine issue number: <a href="https://redmine.mt2.dsd.sztaki.hu:18018/issues/3135">#3135</a>
	 */
	@Test
	@Category(CoreSuite.class)
	public final void testAdminForumIsVisibleWithAuthor() {
...
//		System.out.println(Utils.createGeneralWebElementsFromEnum(GeneralPageLocators.MESSAGE_CENTER_WINDOW_CLOSE_BUTTON_ALTERNATIVE).size());
	...
	/**
	 * Checks citations list view
	 * Redmine issue number: <a href="https://redmine.mt2.dsd.sztaki.hu:18018/issues/3140">#3140</a>
	 */
	@Test
	@Category(CoreSuite.class)
